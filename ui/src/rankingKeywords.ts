export const FOCUS_AREA_KEYWORDS: Record<string, string[]> = {
  ...
  "Social Services":           ["social", "welfare", "poverty", "disability", "elderly", "child", "family", "services", "youth", "young people", "young person", "support", "vulnerable", "underserved", "opportunity", "empowerment"],
